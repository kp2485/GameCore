...
public struct Event: Codable, Sendable, Equatable {
    public enum Kind: String, Codable, Sendable { case turnStart, action, damage, heal, statusApplied, statusExpired, death, note, xpGained, levelUp, goldAwarded, lootDropped }
